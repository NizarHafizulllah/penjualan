<?php echo form_open('stok/tambah', array('id' => 'FormTambahBarang')); ?>
...
function BarisBaru()
{
	...
	var Baris = "<tr>";
	Baris += "<td>"+Nomor+"</td>";
	Baris += "<td><input type='text' name='nama[]' class='form-control input-sm kode_barang'><span id='SamaKode'></span></td>";
